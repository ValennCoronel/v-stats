...
export async function getPlayerDashboardStats(clubId: string, playerId: string, teamId?: string) {
  ...
  const selectedTeam = teamId ? club.teams.find((team) => team.id === teamId) : null
